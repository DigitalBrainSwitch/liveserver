...
function getAverages(data, var_id){
    ...
    function getEntries(var_id, type){
     $.ajax({
          type: "POST",
          url: "http://www.myliferocket.com/ajaxfiles/getEntries.php",
          data:{
...
function reportSave(id, entry_id, value, date, type) {
	//alert("reportSave called. id="+id+", entry_id="+entry_id+",value="+value+", date="+date+", type="+type);
	//alert("reportSave called. user_id="+_userid+", variable_id="+id+", experiment_id="+_experimentid);
	//alert("reportSave called. user_id="+_userid+", variable_id="+id+", experiment_id="+_experimentid+", variable_value="+value+", date_modified="+date);
   ...
   console.log(entry_id);
     $.ajax({
          async:false,
          type: "POST",
          url: "http://www.myliferocket.com/ajaxfiles/saveVars.php",
          //url: "http://www.myliferocket.com/wp-includes/saveVars.php",
          data:{
             id:  entry_id, 
             user_id: _userid,
             variable_id: id,
            ...
            console.log(data);
            //alert("data entry done="+data);
            getEntries(id, type);
            //alert("entry_id="+entry_id);
            //if(entry_id == null || entry_id=='null')
            //if(entry_id=='null')
            {
            	//alert("entry_id is null");
            	//location.reload();
            }
            //	location.reload();
        });
