...
get_header( 'buddypress' ); ?>
	...
	<div id="content">
		...
		<form action="<?php bp_experiment_creation_form_action(); ?>" method="post" id="create-experiment-form" class="standard-form" enctype="multipart/form-data">
			<h3><?php _e( 'Create an Experiment', 'buddypress' ); ?> &nbsp;<a class="button" href="<?php echo trailingslashit( bp_get_root_domain() . '/' . bp_get_experiments_root_slug() ); ?>"><?php _e( 'Experiments Directory', 'buddypress' ); ?></a></h3>
			...
			<div class="item-body" id="experiment-create-body">
				...
				<?php if ( bp_is_experiment_creation_step( 'experiment-avatar' ) ) : ?>
					...
					<?php if ( 'crop-image' == bp_get_avatar_admin_step() ) : ?>
						...
						<h3><?php _e( 'Crop Experiment Avatar', 'buddypress' ); ?></h3>
