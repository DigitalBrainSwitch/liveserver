...
<div class="main-column">
	...
	<?php if ( bp_experiment_has_invites( bp_ajax_querystring( 'invite' ) . '&per_page=10' ) ) : ?>

		<div id="pag-top" class="pagination">

			<div class="pag-count" id="experiment-invite-count-top">

				<?php bp_experiment_invite_pagination_count(); ?>

			</div>

			<div class="pagination-links" id="experiment-invite-pag-top">

				<?php bp_experiment_invite_pagination_links(); ?>
		...
		<div id="pag-bottom" class="pagination">
			...
			<div class="pag-count" id="experiment-invite-count-bottom">

				<?php bp_experiment_invite_pagination_count(); ?>

			</div>

			<div class="pagination-links" id="experiment-invite-pag-bottom">
