...
.form-control-select{
    ...
    background-image: url('http://www.myliferocket.com/wp-content/plugins/buddypress/bp-templates/bp-legacy/buddypress/experiments/images/select-arrow.png');
    
    background-repeat: no-repeat;
    background-position: right;
}
.form-control-select.focus {
  background-image: url('http://www.myliferocket.com/wp-content/plugins/buddypress/bp-templates/bp-legacy/buddypress/experiments/images/select-arrow.png')!important;
  background-repeat: no-repeat;
  background-position: right;
}
</style>
...
<div class='col-xs-4' style='padding:20px; text-align:center'>
    <img src='http://www.myliferocket.com/wp-content/plugins/buddypress/bp-templates/bp-legacy/buddypress/experiments/images/a1.png'/>
    <p style='padding:20px'>Anybody can join</p>
</div>
<div class='col-xs-4' style='padding:20px; text-align:center'>
    <img src='http://www.myliferocket.com/wp-content/plugins/buddypress/bp-templates/bp-legacy/buddypress/experiments/images/b1.png'/>
    <p style='padding:20px'>Shows in experiments directory and search results</p>
</div>
<div class='col-xs-4' style='padding:20px; text-align:center'>
    <img src='http://www.myliferocket.com/wp-content/plugins/buddypress/bp-templates/bp-legacy/buddypress/experiments/images/c1.png'/>
...
<div id='private'>
<div class='col-xs-4' style='padding:20px; text-align:center'>
    <img src='http://www.myliferocket.com/wp-content/plugins/buddypress/bp-templates/bp-legacy/buddypress/experiments/images/a2.png'/>
...
<div class='col-xs-4' style='padding:20px; text-align:center'>
    <img src='http://www.myliferocket.com/wp-content/plugins/buddypress/bp-templates/bp-legacy/buddypress/experiments/images/c2.png'/>
    <p style='padding:20px'>Only experiment members can see the results.</p>
</div>
</div>
<div id='hidden'>
<div class='col-xs-4' style='padding:20px; text-align:center'>
    <img src='http://www.myliferocket.com/wp-content/plugins/buddypress/bp-templates/bp-legacy/buddypress/experiments/images/a3.png'/>
    <p style='padding:20px'>People have to be invited to join.</p>
</div>
<div class='col-xs-4' style='padding:20px; text-align:center'>
    <img src='http://www.myliferocket.com/wp-content/plugins/buddypress/bp-templates/bp-legacy/buddypress/experiments/images/b2.png'/>
