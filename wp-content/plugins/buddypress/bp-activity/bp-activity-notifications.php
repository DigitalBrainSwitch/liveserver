 ...
 * @uses bp_is_experiment()
 * @uses bp_get_current_experiment_name()
...
', 'buddypress' ), $poster_name, $content, $message_link );
		...
		if ( bp_is_active( 'experiments' ) && bp_is_experiment() ) {
			$message = sprintf( __(
'%1$s mentioned you in the experiment "%2$s":
...
---------------------
', 'buddypress' ), $poster_name, bp_get_current_experiment_name(), $content, $message_link );
		} else {
			$message = sprintf( __(
'%1$s mentioned you in an update:
