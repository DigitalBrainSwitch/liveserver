...
function experiments_screen_experiment_activity() {

	if ( ! bp_is_single_item() ) {
		return false;
	}

	do_action( 'experiments_screen_experiment_activity' );

	bp_core_load_template( apply_filters( 'experiments_template_experiment_activity', 'experiments/single/activity' ) );
}
